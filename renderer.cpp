...
void CRenderer::Init()
{
	...
	LIGHT light;
	//light.Position = XMFLOAT4(0.0f, 100.0f, 0.0f, 1.0f);
...
//void CRenderer::SetLight1(ConstantBuffer cb)
//{
//	m_ImmediateContext->UpdateSubresource(m_LightBuffer, 0, NULL, &cb, 0, 0);
//}
